...
// import {'grey', 'grey', 'grey' } from '../Styles/ConstantStyle';
...
const ProductPage = () => {
    ...
    useEffect(() => {
            ...
            const couplesData = mainData.filter((ele) => ele.cat_Id == 4);
            const filtered = mainData.filter((ele) => ele._id == 3);
        ...
        <>
            ...
            <Header/>
                        ...
                        <Box sx={{ width: { lg: "75%", md: "90%", sm: "90%", xs: "100%" } }}>
                            <Grid container >
                                ...
                                <Grid item lg={8} md={8} sm={12} xs={12} sx={{ height: "100%", }}>
                                    ...
                                    <Box sx={{p:"15px"}}>
                                        <Box sx={{ mt: "10px" }}>
                                            <Typography sx={{ fontSize: "15px", color: "#54595F", fontWeight: "900" }}>
                                                MATERIAL
                                            </Typography>
                                            <Typography sx={{ color: 'grey', fontSize: "14px", mt: "3px" }}>
                                ...
                                <Grid item lg={4} md={4}  sm={12} xs={12}>
                                    <Box sx={{ m: "15px" }}>
                                        ...
                                        <Typography sx={{ fontSize: "19.5px", mt: "7px", color: "red" }}>
                                            <span style={{ color: 'grey', marginRight: "5px" }}><s>1,799</s></span>699
                                        </Typography>
                                        ...
                                        <Box>
                                            <select style={{ marginTop: "5px", color: 'grey', padding: "10px", fontWeight: "500", fontSize: "15px", background: "none", outline: "none", border: "1px solid #eeeeee", width: "200px" }}>
                                                ...
                                                <option style={{ color: "black", marginTop: "5px", color: 'grey', margin: "7px" }}>S</option>
                                                <option style={{ color: "black", marginTop: "5px", color: 'grey', margin: "7px" }}>M</option>
                                                <option style={{ color: "black", marginTop: "5px", color:'grey', margin: "7px" }}>L</option>
                                                <option style={{ color: "black", marginTop: "5px", color: 'grey', margin: "7px" }}>XL</option>
                                                <option style={{ color: "black", marginTop: "5px", color:'grey', margin: "7px" }}>XXL</option>
                                        ...
                                        <Grid container sx={{ mt: "10px" }} spacing={2}>
                                            <Grid item lg={3} md={3} sm={3} xs={3} sx={{}}>
                                                <Box style={{ border: `1px solid #e0e0e0`, height: "fit-content", width: "fit-content", display: "flex" }}>
                                                    <Box sx={{ height: "39px", width: "25px", fontSize: "14px", color: 'grey', display: "flex", justifyContent: "center", alignItems: "center" }}><RemoveOutlinedIcon sx={{fontSize:"16px"}}/></Box>
                                                    ...
                                                    <Box sx={{ height: "39px", width: "25px", fontSize: "14px", color: 'grey', display: "flex", justifyContent: "center", alignItems: "center" }}><AddOutlinedIcon sx={{fontSize:"16px"}}/></Box>

                                                </Box>

                                            </Grid>
                                            <Grid item lg={9} md={9} sm={9} xs={9} sx={{ display: "flex", justifyContent: "right" }}>
                                                <Button sx={{ width: "96%", borderRadius: "0PX", height: "40px", color: "white", bgcolor: 'black', "&:hover": { bgcolor: 'black' } }} onClick={()=>{router.push('/addtocartpage')}}> <ShoppingBagOutlinedIcon sx={{ mr: "5px" }} onClick={()=>{router.push('addtocartpage')}} />Add to cart </Button>
                                            </Grid>
                                            <Grid item xs={12}>
                                                <Box>
                                                    <Button fullWidth sx={{ borderRadius: "0PX", height: "40px", color: "white", bgcolor: 'black', "&:hover": { bgcolor: 'black' } }} onClick={()=>{router.push('/buynowpage')}}> <ShoppingBagOutlinedIcon sx={{ mr: "5px" }} onClick={()=>{router.push('buynowpage')}}/>Buy now </Button>
                                                </Box>
                                            </Grid>
                                        ...
                                        <Box sx={{ mt: "30px" }}>
                                            ...
                                            <Typography sx={{ fontSize: "15px", display: "flex", alignItems: "center", color: "#222222", mt: "10px" }}>
                                                Categories:<span style={{ fontSize: "15px", color: 'grey' }}>Man's Half Sleeve, Men's/Women's</span>
                                            </Typography>
                                        </Box>
                                        <Box sx={{ mt: "15px", border: "1px solid black", p: "10px" }}>
                                            ...
                                            <Typography sx={{ color: 'grey', fontSize: "15px", mt: "5px" }}>
                                        ...
                                        <Box>
                                            ...
                                            <Typography sx={{ color: 'grey', fontSize: "15px", mt: "10px" }}>
                                            ...
                                            <Typography sx={{ color: 'grey', fontSize: "15px", mt: "15px" }}>
                                        ...
                                        <Box>
                                            ...
                                            <Box>
                                                <FormGroup>
                                                    <FormControlLabel control={<Checkbox />} label={<Typography sx={{ color: 'grey', fontSize: "15px", mt: "15px" }}>
                                                        Save my name, email, and website in this browser for the next time I comment.
                                                    </Typography>} />
                                                </FormGroup>
                                                <Button sx={{ borderRadius: "0PX", color: "white", fontSize: "12px", bgcolor: 'black', "&:hover": { bgcolor: 'black' }, mt: "20px", p: "5px 15px" }}> Submit </Button>
                                            </Box>
                                                ...
                                                couplesData.map((ele,index) => {
                                                    ...
                                                    return (
                                                        <Box key={index} sx={{ m: { lg: "20px", md: "15px", sm: "12px", xs: "9px" }, cursor: "pointer" }} onMouseEnter={() => { setCardShow(ele._id) }} onMouseLeave={()=>{setCardShow("")}} onClick={()=>{handlePageChange(ele._id)}}>
                                                            <Paper sx={{  pb: "10px", width: { lg: "260px", md: "230px", sm: "210px",xs:"190px" } }}>
                                                                ...
                                                                <Box sx={{ height: { lg: "350px", md: "320px", sm: "270px", xs: "230px" }, backgroundImage: `url(${ele.magnifyImg[0].img.src})`, backgroundSize: "100% 100%", backgroundRepeat: "no-repeat", width: "100%", position: "relative" }}>
                                                                    <span style={{ backgroundColor: '#c62828', top: "10px", left: "10px", padding: "5px 8px", position: "absolute" }}>
                                                                    ...
                                                                    </span>
                                                                    {
                                                                        cardShow == ele._id && (<Box sx={{ height: "90%", width: "100%", position: "absolute", zIndex: 1 }} >
                                                                            ...
                                                                            <Box sx={{ display: "flex", justifyContent: "center", mt: "10px", m: "15px" }}>
                                                                                <Button variant='contained' sx={{ "&:hover": { bgcolor: 'grey' }, fontSize: { xs: "10px" }, bgcolor: 'black', width: { lg: "100%", md: "90%", sm: "80%", xs: "70%" } }} >QUICK VIEW</Button>
                                                                            </Box>
                                                                        </Box>)
                                                                ...
                                                                <Box>
                                                                    ...
                                                                    <Typography align='center' sx={{ fontSize: "14px", mt: "7px" }}>
                                                                        <span style={{ color: 'grey', marginRight: "5px" }}><s>{ele.orgPrice}</s></span>{ele.discPrice}
                                                                    </Typography>
                                                                </Box>
                                                                <Box sx={{ display: "flex", justifyContent: "center", mt: "7px", p: "0px 8px" }}>
                                                                    <Box style={{ border: `1px solid #e0e0e0`, display: "flex" }}>
                                                                        <Box sx={{ height: "30px", width: "40px", fontSize: "14px", color: 'grey', display: "flex", justifyContent: "center", alignItems: "center" }}><RemoveOutlinedIcon /></Box>
                                                                        ...
                                                                        <Box sx={{ height: "30px", width: "40px", ontSize: "14px", color: 'grey', display: "flex", justifyContent: "center", alignItems: "center" }}><AddOutlinedIcon /></Box>
                                                                    </Box>
                ...
                <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", height: "150px" }}>
                    <Button sx={{ bgcolor: 'grey', fontSize: "15px", fontWeight: "900", p: "8px 15px", "&:hover": { bgcolor: 'grey' }, color: "white" }}>
